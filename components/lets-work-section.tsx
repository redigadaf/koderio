          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              ...
              <span className="block overflow-hidden">
                ...
                >
                  <span className="text-purple-600/60">together</span>
                </span>
              </span>
            </h2>
            ...
            <div className="relative mt-4 flex size-16 items-center justify-center sm:size-20">
              <div
                ...
                style={{
                  borderColor: isClicked ? "#9333ea" : isHovered ? "#9333ea" : "var(--border)",
                ...
                style={{
                  transform: isClicked
                    ...
                    : isHovered
                      ...
                      : "translate(0, 0)",
                  opacity: isClicked ? 0 : 1,
                  color: isHovered && !isClicked ? "#ffffff" : "var(--foreground)",
